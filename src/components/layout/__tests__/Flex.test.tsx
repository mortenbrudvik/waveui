...
describe('Flex', () => {
  ...
  it('applies nowrap class', () => {
    render(<Flex wrap="nowrap" data-testid="flex">Content</Flex>);
    expect(screen.getByTestId('flex').className).toContain('flex-nowrap');
  });

  it('applies wrap-reverse class', () => {
    render(<Flex wrap="wrap-reverse" data-testid="flex">Content</Flex>);
