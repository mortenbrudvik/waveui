...
// C-SLOTS naming predicate. Local copy of the rule MessageBar (P12) and SearchBox (P02) apply; it
// moves to the shared F2 helper `src/lib/labelInName.ts` when that lands (spec revision 2.5).
 ...
 * `aria-hidden` and `hidden` subtrees. Text hidden only by CSS is not detected and counts as a
 * label (documented on `dismissIcon`).
 */
